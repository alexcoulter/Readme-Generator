...
var userImg;
const config = {
  headers: { 'Authorization': 'token eee68320e890e5880da582c1df5abdf6888d0d71' }
}
    ...
    axios
      ...
      .then(function (res) {
        ...
        if(res.data.avatar_url) {
          ...
          var userImgLink = `<img alt="user image" src= "${userImg}" width="150px" /> `;
          }
          else {
          var userImgLink = "Sorry! No image to display.";
          }
        console.log(res.data.avatar_url);


        var title = response.projectTitle;
